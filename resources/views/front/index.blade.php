      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            @foreach ($home_banner as $lisitem)
            
            <li>
              <div class="seq-model">
               
                <img data-seq src="{{asset('storage/media/banner/'.$lisitem->image)}}">
              </div>
              @if ($lisitem->btn_txt!='')
              <div class="seq-title">
                <a data-seq target="_blank" href="{{$lisitem->btn_link}}" class="aa-shop-now-btn aa-secondary-btn">{{$lisitem->btn_txt}}</a>
              </div>
              @endif
                  ...
                  if($loop_count==1) {
                    ...
                    <div class="tab-pane fade {{$cat_class}}" id="cat{{$list->id}}">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset('storage/media/'.$productArr->image)}}" alt="{{$productArr->name}}" width="250px"></a>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="featured">
                  <ul class="aa-product-catg aa-featured-slider">
                    ...
                    <li>
                      <figure>
                        <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset('storage/media/'.$productArr->image)}}" alt="{{$productArr->name}}" width="250px" high="100px"></a>
                        <a class="aa-add-card-btn" href="javascript:void(0)" onclick="home_add_to_cart('{{$productArr->id}}','{{$home_featured_product_attr[$productArr->id][0]->size}}','{{$home_featured_product_attr[$productArr->id][0]->color}}')"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                        <figcaption>
                          <h4 class="aa-product-title"><a href="#">{{$productArr->name}}</a></h4>
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            <ul class="aa-client-brand-slider">
              @foreach ($home_brands as $itembrands)
              <li><a href="#"><img src="{{asset('storage/media/brand/'.$itembrands->image)}}" alt="{{$itembrands->name}}"></a></li>
              @endforeach
